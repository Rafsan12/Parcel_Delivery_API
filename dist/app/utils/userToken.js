...
const createUserTokens = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVas.JWT_ACCESS_SECRET, env_1.envVas.JWT_ACCESS_EXPIRES);
    const refreshToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVas.JWT_REFRESH_SECRET, env_1.envVas.JWT_REFRESH_EXPIRES);
    return {
        accessToken,
        refreshToken,
    };
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedRefreshToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVas.JWT_REFRESH_SECRET);
