...
const transporter = nodemailer_1.default.createTransport({
    host: env_1.envVas.EMAIL_SENDER.SMTP_HOST,
    port: Number(env_1.envVas.EMAIL_SENDER.SMTP_PORT),
    secure: true,
    auth: {
        user: env_1.envVas.EMAIL_SENDER.SMTP_USER,
        pass: env_1.envVas.EMAIL_SENDER.SMTP_PASS,
    },
});
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments, }) {
    try {
        ...
        const info = yield transporter.sendMail({
            from: env_1.envVas.EMAIL_SENDER.SMTP_FROM,
            to: to,
            subject: subject,
            html: html,
