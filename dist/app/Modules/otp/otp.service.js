...
const sentOtp = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
...
const verifyOtp = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!saveOtp) {
        throw new AppError_1.default(401, "Invalid Opt");
    }
    if (saveOtp !== otp) {
        throw new AppError_1.default(401, "Invalid Opt");
    }
    yield user_model_1.User.updateOne({ email }, { isVerified: true }, { runValidators: true });
